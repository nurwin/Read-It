  ...
  var TTS = function(defaultLanguage) {
    ...
    self.urls = function(txt, lang) {
      ...
      for (var i=0; i<slices.length; ++i) {
        ...
        urls.push(
          'http://translate.google.com/translate_tts?ie=UTF-8&tl=' + lang + '&q=' + encodeURIComponent(slice) //+ '&textlen=' + slice.length + '&idx=' + i + '&total=' + 1//slices.length
        );
      }
	  ...
	  var delimiter = " ";
		do{
			...
			if (txt.indexOf(".") > -1 && txt.indexOf(".") < tempMax){
				  ...
				  slices.push(txt.substring(0, tempMax).trim());
